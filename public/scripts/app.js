...
$(function() {
  ...
  },
  {
    ...
    function createTweetElement(tweet) {
      ...
      <footer>
      <p>${moment(new Date(tweet.created_at))}
    ...
    $('form').submit(function(evt) {
      ...
      if (text.length === 0) {
        alert('You didn\'t type anything. Please try again!');
      } else if (text.length > 140) {
        alert('Your tweet is longer than 140 characters. Stop tweeting an entire story!');
      } else {
